	...
	if ($screen_id === 'toplevel_page_banhammer') {
		...
		if (!banhammer_check_date_expired() && !banhammer_dismiss_notice_check()) {
			...
			<div class="notice notice-success notice-lh">
				<p>
					<strong><?php esc_html_e('❄️ Winter Sale!', 'banhammer'); ?></strong> 
					<?php esc_html_e('Take 20% OFF any of our', 'banhammer'); ?> 
					...
					<?php esc_html_e('Apply code', 'banhammer'); ?> <code>WINTER20</code> <?php esc_html_e('at checkout. Sale ends 3/28/2026.', 'banhammer'); ?> 
...
function banhammer_check_date_expired() {
	...
	$expires = apply_filters('banhammer_check_date_expired', '2026-03-28');
